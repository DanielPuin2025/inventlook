...
-- Base de datos ajustada y limpia para inventlook
-- ------------------------------------------------------
...
-- Schema inventlook
-- -----------------------------------------------------
DROP DATABASE IF EXISTS `inventlook`;
CREATE DATABASE `inventlook` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci;
USE `inventlook`;
...
CREATE TABLE `usuario` (
  ...
  `rol` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL DEFAULT 'EMPLEADO',
...
CREATE TABLE `producto` (
  ...
  `estado` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL DEFAULT 'Óptimo',
